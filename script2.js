...
let skills = ['Ableton Live', 'Avid Pro Tools', 'DJing', 'Drums', 'Logic Pro X', 'Object Oriented Programming', 'Python', 'R', 'C++', 'Java', 'Bash', 'JavaScript', 'HTML', 'CSS', 'Swift', 'Git', 'Linear Algebra', 'Statistics', 'Probability', 'Quantitative Finance', 'Excel', 'Spanish', 'Customer Service'];
...
let jobs = [
    ...
    Job("Music Producer", "Self-employed", "Ongoing",
        "Writer and producer of electronic music, working under the name REDWAVE. I released four 4-5 song EPs in 2024.",
        "", "")
];
